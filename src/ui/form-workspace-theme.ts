import type { FormWorkspaceRole, FormWorkspaceTheme } from 'pi-tui-orbs'
...
export function createFormWorkspaceTheme(theme: DshTuiTheme): FormWorkspaceTheme {
  ...
  const roles: Record<FormWorkspaceRole, (text: string) => string> = {
