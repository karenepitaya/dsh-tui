...
describe('architecture import boundaries', () => {
  ...
  it.each([
    ...
    ['Skills feature', 'features/skills-entry.ts'],
    ['Tools feature', 'features/tools-entry.ts'],
    ['MCP feature', 'features/mcp-entry.ts'],
    ['Settings feature', 'features/settings-entry.ts'],
    ['product', 'product.ts'],
  ...
  it('keeps every non-DSH public declaration graph free of official DSH types', () => {
    expect(publicDeclarationGraphOffenders([
      ...
      'features/skills-entry.ts',
      'features/tools-entry.ts',
      'features/mcp-entry.ts',
      'features/settings-entry.ts',
      'product.ts',
      'runtime/service.ts',
